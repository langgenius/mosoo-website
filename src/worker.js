...
`;
const AUTH_MARKDOWN = `# Mosoo auth.md
...
Mosoo does not currently publish OAuth authorization-server metadata for this API. Use the self-service token page above; do not invent or probe an OAuth token endpoint.
