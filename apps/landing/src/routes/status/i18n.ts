...
const ZH_MESSAGES = {
  ...
  "Status feed is temporarily unavailable": "状态数据源暂时不可用",
  "Last observed": "最近观测",
  ...
  invocations: "次调用",
  "Observed invocations, 90 days": "90 天观测到的调用",
  "Latest outcome": "最近结果",
  "HTTP status": "HTTP 状态",
  ...
  "{rate} completion": "完成率 {rate}",
  Runs: "次 Run",
  "Observed Runs, 90 days": "90 天观测到的 Run",
  "Latest Run": "最近 Run",
  Duration: "耗时",
  Error: "错误",
  ...
  "54 user-facing Runs for one account failed when stranded Cattle sandboxes exhausted its concurrency capacity. Lifecycle repair reclaimed the capacity.":
    "滞留的 Cattle sandbox 占满一个账号的并发容量，导致 54 次用户 Run 失败。生命周期修复已回收容量。",
  ...
  "8 user-facing ACP Runs across two accounts failed when streamed tool arguments conflicted with durable tool-call identity. The hotfix restored tool execution.":
    "流式工具参数与持久化 Tool Call 身份冲突，导致两个账号的 8 次 ACP 用户 Run 失败。热修已恢复工具执行。",
  ...
  "OpenAI Runtime runs failed before producing a response. Production hotfixes restored sandbox startup, provider routing, and lifecycle recovery.":
    "OpenAI Runtime 在生成回复前失败。生产热修已恢复 sandbox 启动、provider 路由和生命周期收敛。",
...
const JA_MESSAGES = {
  ...
  "{rate} success": "成功率 {rate}",
  invocations: "回の呼び出し",
  "Observed invocations, 90 days": "90 日間に観測した呼び出し",
  ...
  "Recent Run failed; incident threshold not reached":
    "直近の Run は失敗しましたが、インシデント閾値未満です",
  "90-day Run completion rate": "90 日間の Run 完了率",
  "{rate} completion": "完了率 {rate}",
  Runs: "Run",
  "Observed Runs, 90 days": "90 日間に観測した Run",
  "Latest Run": "直近の Run",
  Duration: "所要時間",
  Error: "エラー",
  ...
  "Notice history": "通知履歴",
  "54 user-facing Runs for one account failed when stranded Cattle sandboxes exhausted its concurrency capacity. Lifecycle repair reclaimed the capacity.":
    "滞留した Cattle sandbox が 1 アカウントの同時実行枠を使い切り、ユーザー向け Run 54 件が失敗しました。ライフサイクル修復により枠を回収しました。",
  "Read the account capacity incident postmortem":
    "アカウント容量インシデントのポストモーテムを読む",
  "8 user-facing ACP Runs across two accounts failed when streamed tool arguments conflicted with durable tool-call identity. The hotfix restored tool execution.":
    "ストリーミング中のツール引数が永続化された Tool Call ID と衝突し、2 アカウントの ACP Run 8 件が失敗しました。ホットフィックスでツール実行を復旧しました。",
  "Read the streamed tool identity incident postmortem":
    "ストリーミング Tool Call ID インシデントのポストモーテムを読む",
  "OpenAI Runtime runs failed before producing a response. Production hotfixes restored sandbox startup, provider routing, and lifecycle recovery.":
    "OpenAI Runtime が応答生成前に失敗しました。本番ホットフィックスにより sandbox 起動、provider ルーティング、ライフサイクル復旧を回復しました。",
