...
```bash
curl -X POST "https://cloud.mosoo.ai/api/v1/agents/$AGENT_ID/threads" \
...
Try it at [cloud.mosoo.ai](https://cloud.mosoo.ai), or read the code on GitHub: [langgenius/mosoo](https://github.com/langgenius/mosoo).
