---
title: "From API to CLI + Skill: a new software development paradigm (maybe)"
titleAccent: "CLI"
description: "What changed when mosoo turned its API into a discoverable CLI, organized commands into skills and workflows, and made end-to-end testing readable to both people and coding agents."
date: 2026-07-28
...
heroAlt: "A CLI-first development loop flows from API to specification, through a central CLI with Catalog and Skill modules, into Workflow and E2E testing, then back to the API."
---
...
This problem followed mosoo throughout development. The turning point came when we used [Lathe](https://github.com/lathe-cli/lathe), an open-source API-to-CLI generator, to generate a complete CLI for mosoo.
...
- generated its CLI surface;
- deliberately selected which APIs should and should not become commands;
- identified which commands compose into workflows;
- documented the business situations in which each command applies; and
- wrote the corresponding `SKILL.md` by hand?
